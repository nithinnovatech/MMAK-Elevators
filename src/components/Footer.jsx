                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <div className="flex justify-center md:justify-start space-x-4">
                            ...
                            <a
                                href="https://www.instagram.com/mmak_official?igsh=ZnRzOXFneXZuOXY0&utm_source=qr"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 bg-gray-700 hover:bg-gradient-to-br hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 rounded-full flex items-center justify-center transition-all duration-300"
